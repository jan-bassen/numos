...
import type { NewLayer } from "@/lib/db/schema";
...
import { insertLayerAtTop } from "@/lib/db/queries/layers";
...
export function NewLayerDialog({ children, versionId }: NewElementDialogProps) {
  ...
  const stages: StaticStageDefinition<SchemaType>[] = [_nameStage, _slugStage];
  ...
  async function onSubmit(values: SchemaType) {
    ...
    const newLayer: Omit<NewLayer, "index"> = {
      ...values,
      definition: {
        type: "custom",
        ...definition,
