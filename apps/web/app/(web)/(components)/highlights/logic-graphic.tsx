...
export function LogicGraphic() {
  ...
  return (
    <div className="relative h-full w-11/12 overflow-hidden rounded-tr-[2rem] border-border max-md:border-t border-r bg-muted/20 p-2 shadow-inner md:h-[90%] md:w-5/6 md:rounded-tr-none md:rounded-br-[2rem] md:border-b">
      <div className="h-full w-full rounded-tr-[2rem] bg-[length:100px_100px] bg-[position:50px_50px] bg-[image:var(--dots-grid)] opacity-40 md:rounded-tr-none md:rounded-br-[2rem]" />
      <div className="-left-5 absolute top-10 h-20 w-40 rounded-lg bg-gradient-to-t from-muted to-background shadow-md ring-2 ring-muted-foreground/30 md:left-10">
        <div className="-right-1.5 absolute top-8 z-10 size-3 rounded-lg bg-muted-foreground shadow-md ring-2 ring-muted-foreground/30" />
      </div>
      <svg
        data-testid="connection"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[4.9rem] left-[8.75rem] h-[43px] w-[86px] stroke-2 stroke-muted-foreground md:left-[12.5rem]"
      >
      ...
      <div className="absolute top-20 left-[14.25rem] h-20 w-40 rounded-lg bg-gradient-to-t from-muted to-background shadow-md ring-2 ring-muted-foreground/30 md:left-72">
        <div className="-left-1.5 absolute top-8 z-10 size-3 rounded-lg bg-muted-foreground shadow-md ring-2 ring-muted-foreground/30" />
      </div>
    </div>
  )
}
