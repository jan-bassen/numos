...
export function Navigation() {
  return (
    <div className="fixed z-60 h-14 w-full max-w-[82rem] border border-muted bg-sidebar/80 shadow-sm backdrop-blur-sm md:top-4 md:w-[calc(100%-1.5rem)] md:rounded-full 2xl:w-full">
