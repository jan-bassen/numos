    ...
    <TooltipProvider>
      <Tooltip>
        <svg
          ...
          strokeWidth={2.5}
          className={cn(
            'z-40 inline-block size-5 rotate-90 stroke-secondary-300 align-middle',
        ...
        >
          ...
          <TooltipTrigger asChild>
            <path
              className="cursor-pointer fill-secondary-200 hover:fill-muted hover:stroke-foreground"
